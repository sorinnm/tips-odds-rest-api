    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 overflow-y-scroll">
            <div
                ...
                <a href="{{ url('admin/sports/add') }}">
                    <button type="button" class="btn btn-primary text-end"><i class="bi bi-plus-circle"></i> Add
                    </button>
                </a>
            </div>
                    ...
                    @foreach ($sports as $sport)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button type="button" data-id="{{ $sport->id }}" data-name="{{ $sport->name }}" title="Delete {{ $sport->name }}" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal" class="deleteButton btn btn-danger" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
            ...
            <div class="modal fade" id="confirmDeleteModal" tabindex="-1" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form method="POST" action="{{ route('sports.delete') }}">
                            @csrf
                            @method('DELETE')
