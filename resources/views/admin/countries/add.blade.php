            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h2 class="h2">Add new country</h2>
                    </div>

                    <form name="add-country" method="POST" action="{{ route('countries.add') }}">
                        @csrf
                        <div class="col-6">
                            ...
                            <div class="form-floating mb-3">
                                <select name="sportId" type="text" class="form-control @error('sportId') is-invalid @enderror" id="floatingSportId" aria-describedby="validationServerSportIdFeedback" placeholder="">
                                    ...
                                    @foreach($sports as $sport)
                                        <option value="{{ $sport->id }}" {{ old('sportId') == $sport->id ? "selected" : '' }}>{{ $sport->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-floating mb-3">
                                <input name="authorId" value="{{ old('authorId')}}" type="text" class="form-control @error('authorId') is-invalid @enderror" id="floatingAuthorId" aria-describedby="validationServerAuthorIdFeedback" placeholder="">
